...
/**
 * Interface para ler números, caracteres e strings por input standard
 *
 * @author Cay Horstmann
 * <p>
 * Alterado e complementado por Salvador Lima
 * <p>
 * Manter a mensagem de copyrigth.
...
public class Console {
    ...
    public static byte readByte() {
        ...
        return readByte("Entre com um valor do tipo 'byte' " +
                "(0 default) : ", 0);
    }
    ...
    public static short readShort(String pPrompt, long pValor) {
        ...
        while (true) {
            ...
            try {
                ...
                System.out.println("Valor inválido para o tipo 'short'");
                System.out.println("Digite novamente...");
            }
        }
    }
    ...
    public static short readShort() {
        ...
        return readShort("Entre com um valor do tipo 'short' " +
                "(0 default) : ", 0);
    }
    ...
    public static int readInt(String pPrompt, long pValor) {
        ...
        while (true) {
            ...
            try {
                ...
                System.out.println("Valor inválido para o tipo 'int'");
                System.out.println("Digite novamente...");
            }
        }
    }
    ...
    public static int readInt() {
        ...
        return readInt("Entre com um valor do tipo 'int' " +
                "(0 default) : ", 0);
    }
    ...
    public static long readLong(String pPrompt, long pValor) {
        ...
        while (true) {
            ...
            try {
                ...
                System.out.println("Valor inválido para o tipo 'long'");
                System.out.println("Digite novamente...");
            }
        }
    }
    ...
    public static long readLong() {
        ...
        return readLong("Entre com um valor do tipo 'long' " +
                "(0 default) : ", 0);
    }
    ...
    public static float readFloat(String pPrompt, double pValor) {
        ...
        while (true) {
            ...
            try {
                ...
                System.out.println("Valor inválido para o tipo 'float'");
                System.out.println("Digite novamente...");
            }
        }
    }
    ...
    public static float readFloat() {
        ...
        return readFloat("Entre com um valor do tipo 'float' " +
                "(0 default) : ", 0);
    }
    ...
    public static double readDouble(String pPrompt, double pValor) {
        ...
        while (true) {
            ...
            try {
                ...
                System.out.println("Valor inválido para o tipo 'double'");
    ...
    public static double readDouble() {
        ...
        return readDouble("Entre com um valor do tipo 'double' " +
                "(0 default) : ", 0);
    }
    ...
    public static boolean readBoolean(String pPrompt, boolean pValor) {
        ...
        while (true) {
            ...
            if (tLinha.equalsIgnoreCase("false"))
                return false;
            System.out.println("Valor inválido para o tipo 'boolean' " +
                    "(true/false)");
            System.out.println("Digite novamente...");
        }
    }
    ...
    public static boolean readBoolean(boolean pVlr) {
        ...
        return readBoolean("Entre com um valor do tipo 'boolean' " +
                "(true/false) (" + pVlr + " default) : ", pVlr);
    }

    public static boolean readBoolean() {

        return readBoolean("Entre com um valor do tipo 'boolean' " +
                "(true/false) ('false' default) : ", false);
    }
    ...
    public static char readChar() {
        ...
        return readChar("Entre com um valor do tipo 'char' " +
                "('\0' default) : ", '\0');
    }
